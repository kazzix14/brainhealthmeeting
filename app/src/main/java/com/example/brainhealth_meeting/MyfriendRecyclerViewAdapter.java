...
import com.example.brainhealth_meeting.friendFragment.OnListFragmentInteractionListener;
...
public class MyfriendRecyclerViewAdapter extends RecyclerView.Adapter<MyfriendRecyclerViewAdapter.ViewHolder> {
    ...
    public MyfriendRecyclerViewAdapter(List<SimpleProfileItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
